...
if statusCode == "":
    ...
    if tstart92 != "" :
      ...
      print("nicos_oracle_jobstat_test.py: Warning: no start time retrieved from results file, using current ",ts_inp)
    ...
    if tend92 != "" :
      ...
      print("nicos_oracle_jobstat_test.py: Warning: no end time retrieved from results file, using current ",ts_inp)
...
print("nicos_oracle_jobstat.py: updating ", stepDBN, "code:",statusCode,"tval:", ts,"jid,projid:",jid,projid_current)
