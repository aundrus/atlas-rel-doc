...
stepDict.update({'im':'IM', 'image':'IM'})
stepDict.update({'cp':'CP', 'CPACK':'CP', 'cpack':'CP'})
...
procid='100000'
version_setting=""
if stepDBN == "EXT": version_setting=" , V"+stepDBN+" = '1'"
cmnd0="update jobstat j set E"+stepDBN+" = NULL , S"+stepDBN+" = NULL"+version_setting
cmnd1="update jobstat j set B"+stepDBN+" = :t_val"+version_setting
cmnd2="update jobstat j set E"+stepDBN+" = :t_val , S"+stepDBN+" = :statusCode"+version_setting
cmnd3="update jobstat j set E"+stepDBN+" = :t_val"+version_setting
cmnd9="""
where j.relid=:relid_j
and j.jid=:jid
and j.nid = :nightly_id
