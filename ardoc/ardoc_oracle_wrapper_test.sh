...
shift
command=$@
source $ARDOC_HOME/ARDOC_oracle_setup_test.sh
hostnm=`hostname`
...
echo "[ARDOC, Oracle interface wrapper (test) start time] $start_test"
echo "[ARDOC, Oracle interface wrapper (test) end time]" `date`
